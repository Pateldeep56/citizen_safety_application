 ...
 */
public class activity_magnetometer extends AppCompatActivity implements SensorEventListener {
...
//            editor.apply();
//
//            final AlertDialog.Builder alert = new AlertDialog.Builder(activity_magnetometer.this);
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floatingActionButton.setOnClickListener (new View.OnClickListener () {
            @Override
            public void onClick(View v) {
                startActivity( new Intent ( getApplicationContext(), Mag_btn.class ) );
        ...
        if (magnetometer != null){
            sensorManager.registerListener(activity_magnetometer.this,magnetometer,SensorManager.SENSOR_DELAY_NORMAL);
        }else {
