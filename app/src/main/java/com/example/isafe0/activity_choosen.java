...
public class activity_choosen extends AppCompatActivity {
...
//            editor.apply();
//
//            final AlertDialog.Builder alert = new AlertDialog.Builder(activity_choosen.this);
...
//        } );
        ...
        testing.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity( new Intent( getApplicationContext(), activity_magnetometer.class ) );
            }
        } );
